...
<form action="?p=rentreview" method="POST">
<input type="hidden" name="address_id" value=<?php echo $tmp_add_id;?>>
<table class="options_table">
<tr><th>&nbsp;</th><th>Delivery Method</th></tr>
<?php
...
foreach($shipping_methods AS $shipping_method){
  ...
  echo "></td><td>".$shipping_method[$cart_obj->tbFields5['shipping_method']]."</td></tr>";
}
?>
</table>
<p>
...
?><p>
<form action="?p=rentcheckout" method="POST">
<table class="form_table">
