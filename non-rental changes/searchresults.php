...
function showoverlay(w,h,s)
{
  ...
  obj1.style.left = "30%";
  obj1.style.top = "30%";
  obj1.style.width = wt + "px";
  obj1.style.height= ht + "px";
  
  
  obj1.style.margin = "-" + ((ht/2) + 30) + "px" + " 0px 0px -" + (wt/2) + "px";  
...
function growoverlay(w,h,s)
{
  sizeTimer=setInterval("showoverlay("+w+","+h+",'"+s+"')",10);
}
</script>
