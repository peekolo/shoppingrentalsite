...
// Make file in download folder
  ...
  // Start Get Product
    ...
    while ($row = mysql_fetch_assoc($dat)) {
      ...
      $data["RENTAL_QUANTITY"] = $row["RENTAL_QUANTITY"];
